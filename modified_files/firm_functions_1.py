...
def determine_is_ai(omega, p, H, Fix_cost_ai, omega_ai, ai_tax_rate, A, gamma):
    ...
    partial_profit = partial(profit, omega=omega, p=p, S_M=imagined_supply,
                             H_M=H, Fix_cost_ai=Fix_cost_ai, omega_ai=omega_ai,
                             ai_tax_rate=ai_tax_rate)
    profit_with_ai, profit_without_ai = (partial_profit(is_ai=True),
                                         partial_profit(is_ai=False))
